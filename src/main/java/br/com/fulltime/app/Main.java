...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Interpretador.getTamanho(hexArray));
        System.out.println(Interpretador.getComando(hexArray));
        for (int i = 0; i < 8; i++) {
            System.out.println(Interpretador.getDados(hexArray)[i]);
        }
